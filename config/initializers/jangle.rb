Jangle.configure do |config|
  ...
  # Override the host used to look up the active Jangle::Site.  If you are not
...
# Default credentials for Jangle::HttpAuth
...
#   Jangle::ViewHooks.add(:navigation, '/layouts/admin/navigation')
#   Jangle::ViewHooks.add(:html_head, '/layouts/admin/html_head')
#   Jangle::ViewHooks.add(:page_form, '/layouts/admin/page_form')